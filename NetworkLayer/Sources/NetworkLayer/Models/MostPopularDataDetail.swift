...
public struct MostPopularDataDetail: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, rank: String? = nil, rankUpDown: String? = nil, title: String? = nil, fullTitle: String? = nil, year: String? = nil, image: String? = nil, crew: String? = nil, imDbRating: String? = nil, imDbRatingCount: String? = nil) {
        self.id = id
        self.rank = rank
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(rankUpDown, forKey: .rankUpDown)
